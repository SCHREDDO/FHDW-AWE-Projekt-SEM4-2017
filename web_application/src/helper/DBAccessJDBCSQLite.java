...
public class DBAccessJDBCSQLite extends DBAccessJDBC{
	...
	{
		List<Object[]> temp = new ArrayList<Object[]>();
		String sql = "select p.peid, p.pid, p.firstname, p.larstname, p.short, p.password, p.e_mail,address, p.phone_number, s.stid, s.sgid, s.matrikelnumber, g.sgid, g.short from person as p, student as s, study_group as g where p.peid = s.peid and s.sgid = g.sgid";
	...
	{
		List<Object[]> temp = new ArrayList<Object[]>();
		String sql = "select p.peid, p.pid, p.firstname, p.larstname, p.short, p.password, p.e_mail, p.address, p.phone_number, l.leid, l.is_honouree_lecturer from person as p, lecturer as l where p.peid = l.peid";
	...
	{
		List<Object[]> temp = new ArrayList<Object[]>();
		String sql = "select p.peid, p.pid, p.firstname, p.larstname, p.short, p.password, p.e_mail, p.address, p.phone_number, a.aeid, a.task_area from person as p, administration_employee as a where p.peid = a.peid";
