...
public class Index {
	...
	public static void main(String[] args) throws Exception {
		...
		contect.addServlet(LecturerCreateController.class, "/Dozent/Create");
		...
		contect.addServlet(LecturerShowController.class, "/Dozent/Show");
		...
		contect.addServlet(ModulController.class, "/Module");
